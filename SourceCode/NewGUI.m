...
function NewGUI
    ...
    FlagsStrings = {'是否绘制性能曲线？','是否绘制演示模型？','是否输出点坐标？','是否输出stl文件'};
    FlagsTips = {'Analyze_flag','Geometry_flag','Coordinate_flag','3DPrint_flag'};
    FlagsValues_def = {Analyze_flag_def,Geometry_flag_def,Coordinate_flag_def,Printing_flag};
    for index = 1 : 4
