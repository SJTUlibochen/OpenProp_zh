...
function OpenPropSingle
    ...
    OpenPropDirectory = 'OpenProp_official-revised-branch';
    ...
    Filename = uicontrol('parent',Tools,...
                         ...
                         'backgroundcolor',editboxcolor,...
                         'string',filename,...
                         'position',[2+filenametext Toolboxht-4 filenamebox editboxht]);
...
function execute(hObject,ED)
    ...
    %% 获得当前的工作目录，并移动工作目录至'OpenProp_official-revised-branch'文件夹下的新建的filename文件中
