...
%
%这段程序用于决定满足给定输入条件的环量、弦长和叶片厚度分布的最优解
%基于的原理是Coney于1989年提出的基于螺旋桨情况的差异化优化算法，或者是
%Epps和Kimball于2011年提出的基于涡轮叶片的...理论
%
...
%
%该程序返回pt结构下的design结构化数组数据，包括进速系数、效率和优化后的环量分布、弦长分布等
%
% -------------------------------------------------------------------------
%
...
if Plot_flag == 1
    ...
    % ------------------------------------------------- Uncomment to plot G
    Hgamma = fig;                  set(Hgamma,'Position',[130 200 560 420])
        HHgamma = plot(RC,G,'k.-');   
    ...
    Hvel = fig;                      set(Hvel,'Position',[695 200 560 420])
        if Duct_flag == 1
